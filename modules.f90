    ...
    if (present(error)) then
        ...
        ! Christiane 
        write(*,'("w_0                  = ",f9.6)') (CP%bbar/3.0d0-1.0d0)/(1.0d0+CP%bbar)
        as = 0.0000248*(1._dl+7._dl/8*(4._dl/11)**(4._dl/3)*(CP%Num_Nu_massless+CP%Num_Nu_Massive))/(CP%H0/100)**2
        as2=0.0000248*(1._dl+7._dl/8*(4._dl/11)**(4._dl/3)*(CP%Num_Nu_massless))/(CP%H0/100)**2

        write(*,'("Omega_e^B            = ",f9.6)') CP%bbar*CP%omegav/(CP%bbar*CP%omegav+(CP%bbar+1)*as)
        write(*,'("otherwise Omega_e^B  = ",f9.6)') CP%bbar*CP%omegav/(CP%bbar*CP%omegav+(CP%bbar+1)*as2)
